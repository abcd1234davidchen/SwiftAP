        ...
        if ProcessInfo.processInfo.environment["XCODE_RUNNING_FOR_PREVIEWS"] == "1" {
            ...
            let fakeCourses = [
                DataItem(code: "TEST001", name: "Test Course 1", professor: "Test Professor",
                        ...
                        friday: "234", saturday: "", sunday: "", colorHex: colorHexList[0], englishName: "T1", grade:""),
                DataItem(code: "TEST002", name: "Test Course 2", professor: "Test Professor",
                        ...
                        friday: "", saturday: "", sunday: "", colorHex: colorHexList[1], englishName: "T1", grade:""),
                DataItem(code: "TEST003", name: "Test Course 3 with a super long name", professor: "Test Professor",
                        credit: "3", room: "Test Room", monday: "B", tuesday: "12", wednesday: "A124", thursday: "789",
                        friday: "", saturday: "", sunday: "", colorHex: colorHexList[2], englishName: "T1", grade:""),
                DataItem(code: "TEST004", name: "Test Course 4", professor: "Test Professor",
                        ...
                        friday: "567", saturday: "", sunday: "", colorHex: colorHexList[3], englishName: "T1", grade:""),
                DataItem(code: "TEST005", name: "Test Course 5", professor: "Test Professor",
                        ...
                        friday: "", saturday: "", sunday: "", colorHex: colorHexList[4], englishName: "T1", grade:"")
            ]
